...
analysis_outdir = "Analysis_navierstokes_pureDG_$(run_label)"
solution_outdir = "out_navierstokes_pureDG_$(run_label)"
...
###############################################################################
# solver, pure DG flux differencing, no shock capturing
